...
export const node = async (args, kernel) => {
    if (args.length === 0) {
    ...
    if (args[0] === '-e' && args[1]) {
        try {
            ...
            try {
                ...
                for (const line of lines) {
                    ...
                    if (k && v)
                        processMock.env[k.trim()] = v.join('=').trim();
                }
            }
      ...
      `);
            ...
            const result = await fn(safeConsole, (p) => mockRequire(p, kernel.getCWD()), typeof fetch !== 'undefined' ? maskedFetch : undefined, typeof Headers !== 'undefined' ? Headers : undefined, typeof Request !== 'undefined' ? Request : undefined, typeof Response !== 'undefined' ? Response : undefined, processMock, kernel.getCWD(), kernel.getCWD() + '/eval.js');
            let finalOut = getOutput();
            if (result !== undefined && !finalOut)
                finalOut += String(result);
    ...
    `);
        ...
        await fn(safeConsole, (p) => mockRequire(p, __dirname), moduleEnv, moduleEnv.exports, typeof fetch !== 'undefined' ? maskedFetch : undefined, typeof Headers !== 'undefined' ? Headers : undefined, typeof Request !== 'undefined' ? Request : undefined, typeof Response !== 'undefined' ? Response : undefined, processMock, __dirname, __filename);
